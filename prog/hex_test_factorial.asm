...
blt  r2, r1, _end           ;                   : while loop condition check and potential exit (jmp to label _end)
beq r0, r0, _outer_loop     ;                   : while loop jump back (unconditioned) to label _outer_loop
;=========================================
_factorial:
;=========================================
...
incl r6, -1                 ; r6 <- r6 - 1
bneq r6, r0, _inner_loop    ;                   : loop until r6 is zero
